  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'p',
          html: 'If you cannot access the App, you can request account and data deletion by contacting us at <a href="mailto:support@getgourmetpedia.com">support@getgourmetpedia.com</a>.',
        },
        {
          kind: 'p',
