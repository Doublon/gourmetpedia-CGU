  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'p',
          html: 'Se non può accedere all\'App, può richiedere l\'eliminazione dell\'account e dei dati contattandoci all\'indirizzo <a href="mailto:support@getgourmetpedia.com">support@getgourmetpedia.com</a>.',
        },
        {
          kind: 'p',
